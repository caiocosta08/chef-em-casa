...
<!DOCTYPE html>
	<head>
		...
		<title>Chef em Casa - SOBRE</title>
        ...
        <div class="container-fluid text-center">
			<div class="row">
				...
				<div class="col-md-8 text-left">
					...
					<h2>Quem somos?</h2>
					<h3>
						Somos o maior portal de Chefs de Cozinha do Brasil! Aqui você encontra os profissionais mais 
						capacitados para trabalharem no seu evento de acordo com sua necessidade. Chefs com as mais variadas habilidades 
						disponíveis para lhe darem a maior assistência possível quando se fala de comida! 
					</h3>
				</div>
				<div class="col-md-2 sidenav">
